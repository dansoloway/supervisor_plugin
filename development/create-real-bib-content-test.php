<?php
/**
 * Create Real Bibliography Content for qa_tags - TEST VERSION
...
echo '<h1 style="color: #333;">יצירת תוכן ביבליוגרפי אמיתי - גרסת בדיקה</h1>';
...
foreach ($tags as $tag) {
    if (!isset($real_bibliography[$tag->name])) {
        echo '<p style="color: orange;">לא נמצא תוכן ביבליוגרפי לקטגוריה: ' . esc_html($tag->name) . '</p>';
        continue;
    }
...
echo '<p style="font-size: 18px; font-weight: bold; color: #0073aa;">נוצרו ' . $created_count . ' פריטי ביבליוגרפיה אמיתיים</p>';
