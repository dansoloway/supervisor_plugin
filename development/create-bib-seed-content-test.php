<?php
/**
 * Test Seed Content Creator for Bibliography Items (No Permissions Check)
 */
...
echo '<title>יצירת תוכן זרע לביבליוגרפיה - גרסת בדיקה</title>';
echo '<style>';
...
echo '<h1>יצירת תוכן זרע לביבליוגרפיה - גרסת בדיקה</h1>';

// Skip permissions check for testing
echo '<p class="warning">⚠️ גרסת בדיקה - בדיקת הרשאות מושבתת</p>';
